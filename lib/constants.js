...
export const API_TOKEN_1 = process.env.CLOUDFLARE_API_TOKEN_1;

export const API_TOKEN_2 = process.env.CLOUDFLARE_API_TOKEN_2;

export const API_TOKEN_3 = process.env.CLOUDFLARE_API_TOKEN_3;
